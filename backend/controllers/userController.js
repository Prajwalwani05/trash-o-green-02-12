...
const registerUser = async (req, res) => {
  ...
  try {
      ...
      const token = jwt.sign({ userRole: role,  coins: newUser.coins, userId: newUser.id, userEmail: newUser.email, userMobile: newUser.mobile, userName: newUser.name, userArea: newUser.area, userAddress: newUser.address }, process.env.JWT_SECRET, { expiresIn: '1h' });
...
module.exports = { registerUser, loginUser, profileUser, updateUser, getAllUsers, saveUser, deleteUser, addUser, updateUserFromBooking , updateUserCoin};
