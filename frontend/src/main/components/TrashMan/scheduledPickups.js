...
const ScheduledPickups = () => {
  ...
  const validBookings = bookings.filter(
    (booking) => booking.status !== "Completed" && booking.status !== "Cancelled" && booking.calculatedWeight !== null
  );
  ...
  return (
    ...
    >
      ...
      >
        <Typography pl={1} variant="h6" mb={1}>Scheduled Pickups</Typography>
        ...
        {loading ? (
          ...
          >
            ...
            <Typography
              ...
              color="gray"
            >
              There is nothing in your scheduled pickups.
            </Typography>
          </Box>
        ) : (
              ...
              >
                ...
                >
                  <Box>
                    ...
                    >
                      <p>{new Date(booking.pickUpDate).toLocaleDateString("en-GB", { weekday: "short" })}</p>
                      <p>{new Date(booking.pickUpDate).toLocaleDateString("en-GB", { day: "2-digit" })}</p>
                    </Typography>
                  </Box>
